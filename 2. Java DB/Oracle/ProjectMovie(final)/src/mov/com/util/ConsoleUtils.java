...
public class ConsoleUtils {
	...
	public int showMenu(Scanner sc) {
		...
		System.out.println("1. 영화 정보 등록하기");
		System.out.println("2. 영화 정보 수정하기");
		System.out.println("3. 영화 정보 삭제하기");
		System.out.println("4. 영화 정보 검색하기");
		System.out.println("5. 전체 영화 정보 살펴보기");
		System.out.println("6. 전체 회원 정보 출력하기");
		System.out.println("7. 영화별 투표수 보기(내림차순)");
	...
	public void show(ArrayList<MovieDTO> list) {
		System.out.println("등록된 영화정보 출력은 다음과 같습니다.▼ ");
...
//			System.out.print("※투표수 "+ (i+1) + "위※ ");  // 투표수가 동일해도 순위가 다르게 나타나는 문제...
	...
	public void showw(ArrayList<AccountDTO> list) { // 회원정보
		System.out.println("등록된 회원정보 출력은 다음과 같습니다.▼ ");
		for (int i = 0; i < list.size(); i++) {
			System.out.println(list.get(i));
			System.out.println("---------------------------------------------------");
		}
	...
	public int showStart(Scanner sc) {
		System.out.println("\n☆★☆★ MEGABOX ☆★☆★");
	...
	public int showMenu1(Scanner sc) {
		...
		System.out.println("1. 관심 영화 투표하기");
		System.out.println("2. 영화 예매하기");
		System.out.println("3. 투표한 영화 목록 보기");
	...
	public AccountDTO makeAccount(Scanner sc) {
		AccountDTO dto = null;
		...
		return new AccountDTO(id, name, "0", "0");
	}
}